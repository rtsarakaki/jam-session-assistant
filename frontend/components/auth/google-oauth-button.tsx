type GoogleOauthButtonProps = {
  /** Full href, e.g. `/auth/google?next=%2Fapp` */
  href: string;
};
...
/** Link-styled control that starts the server OAuth route (`/auth/google`). */
export function GoogleOauthButton({ href }: GoogleOauthButtonProps) {
  return (
    <a
      href={href}
