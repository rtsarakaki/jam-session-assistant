...
/** Handle field: slightly smaller than other profile inputs (`text-xs` literal for Tailwind scan). */
export const validatedUsernameInputClass =
  "mt-1 w-full rounded-lg border border-[#2a3344] bg-[#1e2533] px-3 py-2 text-xs text-[#e8ecf4] placeholder:text-[#8b95a8] outline-none ring-[#6ee7b7]/40 focus:border-[#6ee7b7]/50 focus:ring-2";
